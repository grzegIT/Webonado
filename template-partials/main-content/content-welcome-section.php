<section class="welcome" id="welcome-id">
    <div class="main-container">  
        <div class="text-block__vertical">
            <h2><?php the_field('welcoming-header',50); ?></h2>
            <p><?php the_field('welcoming-paragaph',50);?></p>
        </div>                
                
        <div class="image-container">
            <img src="<?php echo the_field('main-image', 50);?>" alt="" class="welcome__img">
            <div class="delivery-info">  
                <p>When ordering from <span class="bold theme-font_color"><?php the_field('free-delivery-text');?></span> USD, delivery is free</p>
                <img src="<?php echo bloginfo('template_url').'/assets/icons/utility-icons/path-icon.svg'?>" alt="" />
            </div>
        ...
        <img src="<?php echo bloginfo('template_url').'/assets/vegetables/tomato@1x.png'?>" alt="" class="absolute-class tomato">
